...
<head>
    ...
    <title>VulDash - Objectives Type</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>">VulDash - Objectives Type</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Objectives Type</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-wrench fa-fw"></i> Objectives Type
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form id="editForm" class="form-horizontal" action="<?php echo base_url('objectivestype/save');?>">
    ...
    <script>
        $(document).ready(function() {
            $('#data').DataTable({
                responsive: true,
                "ajax": "<?php echo base_url('objectivestype/list');?>",
                "columns": [
            ...
            $("#data tbody").on("click", "#edit", function () {
                ...
                $.ajax({
                    url: "<?php echo base_url('objectivestype/edit');?>",
                    data: {id: id},
            ...
            $("#data tbody").on("click", "#delete", function () {
                if(confirm("Delete the record?"))
                {
                    var id = $(this).parent().parent().parent().attr("id");
                    $.ajax({
                        url: "<?php echo base_url('objectivestype/delete');?>",
                        data: {id: id},
                        success: function(result) {
