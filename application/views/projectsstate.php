...
<head>
    ...
    <title>VulDash - Projects State</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>">VulDash - Projects State</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Projects State</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-wrench fa-fw"></i> Projects State
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">                            
                                    <form id="editForm" class="form-horizontal" action="<?php echo base_url('projectsstate/save');?>">
    ...
    <script>
        $(document).ready(function() {
            $('#data').DataTable({
                responsive: true,
                "ajax": "<?php echo base_url('projectsstate/list');?>",
                "columns": [
            ...
            $("#data tbody").on("click", "#edit", function () {
                ...
                $.ajax({
                    url: "<?php echo base_url('projectsstate/edit');?>",
                    data: {id: id},
            ...
            $("#data tbody").on("click", "#delete", function () {
                ...
                {                
                    var id = $(this).parent().parent().parent().attr("id");
                    $.ajax({
                        url: "<?php echo base_url('projectsstate/delete');?>",
                        data: {id: id},
                        success: function(result) {
