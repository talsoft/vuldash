...
<head>
    ...
    <title>VulDash - Incidents Type</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>">VulDash - Incidents type</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Incidents Type</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-wrench fa-fw"></i> Incidents Type
    ...
    <script>
        $(document).ready(function() {
            $('#data').DataTable({
                responsive: true,
                "ajax": "<?php echo base_url('incidentstype/list');?>",
                "columns": [
            ...
            $("#new").on("click", function () {
                $.ajax({
                    url: "<?php echo base_url('incidentstype/create');?>",
            ...
            $("#data tbody").on("click", "#edit", function () {
                ...
                $.ajax({
                    url: "<?php echo base_url('incidentstype/edit');?>",
                    data: {id: id},
                    success: function(result) {
                        $("#modalForm").html(result); 
                        $("#modalForm").modal(); 
            ...
            $("#data tbody").on("click", "#delete", function () {
                if(confirm("Delete the record?"))
                {
                    var id = $(this).parent().parent().parent().attr("id");
                    $.ajax({
                        url: "<?php echo base_url('incidentstype/delete');?>",
                        data: {id: id},
                        success: function(result) {
